...
class Chip2HiCDataset(torch.utils.data.Dataset):
    def __init__(self, seq_length=200, window_size=14000, chroms=['chr22'], mode='train', save_dir='/home/yangpeida/HiATAC/Tech/epiphany/Epiphany_dataset', zero_pad=True):
